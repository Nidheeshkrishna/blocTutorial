  ...
  Widget build(BuildContext context)  {
    ...
    return Scaffold(
      bottomNavigationBar:
        ...
        body: SafeArea(child:
        BlocBuilder<BottamNavigationBlocBloc, BottamNavigationBlocState>(builder: (context, state) {
          // return PageView(
            ...
            return WillPopScope(
                onWillPop: () async {
                  if (state.currentIndex == 0) {
                    ...
                    BlocProvider.of<BottamNavigationBlocBloc>(context).add(ChangePageEvent(0));
                    return false;
                  }
                },
