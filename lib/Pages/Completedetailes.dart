                        ...
                        Center(
                          child: Card(
                            ...
                            child: Container(
                              ...
                              height: SizeConfig.screenwidth * .090,
                                ...
                                if (state is LocationSuccesss) {
                                  return SizedBox(
                                    ...
                                    child: DropdownButtonFormField<dynamic>(
                                      ...
                                      onChanged: (newValue) {
                                        final fetchlocation = BlocProvider.of<
                                            ServiceAreaBlocBlocBloc>(context);
                                        fetchlocation.add(FetchServiceAraea(
                                            "9", newValue.toString()));

                                        gtdata.setPincode = newValue.toString();
                                      ...
                                      items: state.pincodes.result.isNotEmpty
                                ...
                                if (state is ServiceAreaSuccesss) {
                                  return SizedBox(
                                    ...
                                    child: DropdownButtonFormField<dynamic>(
                                        ...
                                        onChanged: (newValue) {
                                          gtdata.setArea = newValue.toString();
                                        },
                                        items: state.pincodes.result
                                            .map<DropdownMenuItem>((value1) {
                                          ...
                                          return DropdownMenuItem(
                                            ...
                                            value: value1.oalOfficeAddressId
                                                .toString(),
                                            child: Text(value1.oalOfficeName,
                                                style: const TextStyle(
                                                    fontSize: 15)),
                                          );
                                        }).toList(),
                                  ...
                                  return const SizedBox();
                                } else if (state is ServiceAreaLoadingstate) {
                                  return SizedBox(
                                      width: srcwidth * .78,
                                      height: srcheight * .10,
                                      child: Row(
